...
- Visualize hard new concepts: when Mahmoud reports that a new mental model is unclear, pause syntax, use a small drawing or interactive visualization, connect it to a familiar frontend/CSS idea when useful, and resume code only after he can explain the picture. Keep easy concepts text-first and avoid decorative artifacts.
